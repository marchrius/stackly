...
final class Version20250820093147 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE koi_import DROP CONSTRAINT FK_7FE294F4514956FD');
        $this->addSql('ALTER TABLE koi_import DROP CONSTRAINT FK_7FE294F47E3C61F9');
        $this->addSql('DROP TABLE koi_import');
    }
}
